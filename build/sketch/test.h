#line 1 "C:\\Users\\Daniel\\Documents\\GitHub\\PerformanceMetricsKit\\shifting\\test.h"
...
const int getUpshiftPin() {
    return upShiftPin;
}

const int getDownshiftPin() {
    return downShiftPin;
}

const int getShiftSolenoid12() {
    return shiftSolenoid12;
}

const int getShiftSolenoid34() {
    return shiftSolenoid34;
}

const int getCrankSensorPin() {
